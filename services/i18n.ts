...
const translations = {
  ar: {
    ...
    marathon: "الماراثون",
    servants: "بوابة متابعة شباب الاجتماع",
    servantPortal: "بوابة الخادم",
    specialFollowUp: "متابعة خاصة",
  ...
  en: {
    ...
    marathon: "Marathon",
    servants: "Meeting Youth Follow-up Portal",
    servantPortal: "Servant Portal",
